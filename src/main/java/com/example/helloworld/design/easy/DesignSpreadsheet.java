...
/**
 * leetcode 3484. Design Spreadsheet , Rippling interview question
 *
 * code harmony explanation video : https://youtu.be/cnKFWF3mOXk
 *
...
class Spreadsheet {
    ...
    public Spreadsheet(int rows) {
        // we don't need rows in the map, just validate if needed
        map = new HashMap<>();
    }
